...
dres = 1;   % Range resolution in meter
Rmax = 200; % max range in meter
Vmax = 100; % max velocity in m/s

%% User Defined Range and Velocity of target
% define the target's initial position and velocity. Note : Velocity
% remains contant

target_range = 100; % Range cannot exceed the max value of 200m.
target_velocity = -10; % velocity can be any value in the range of -70 to + 70 m/s.
...
figure,surf(doppler_axis, range_axis, cfar_signals);
colorbar;
